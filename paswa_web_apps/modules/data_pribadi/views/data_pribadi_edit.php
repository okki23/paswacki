        ...
        <div id="page_content_inner">
            ...
            <div class="md-card">
                <div class="md-card-content">
                    <h1>Data Pribadi</h1>
                    <span class="uk-text-upper uk-text-small">Form Edit Data Pribadi</span>
                   <form action="<?php echo base_url('data_pribadi/pro_edit');?>" method="POST" enctype="multipart/form-data"> 

                   <input type="hidden" name="user_id" value="<?php echo $listing->user_id;?>">
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            <label> NIM </label>
                            <input type="text" class="input-count md-input" id="input_counter" name="nim" value="<?php echo $listing->nim;?>"  maxlength="12" />
                        </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            <label>Nama</label>
                            <input type="text" class="input-count md-input" id="input_counter" name="nama_peserta" value="<?php echo $listing->nama_peserta;?>" maxlength="50" />
                        </div>
                        ...
                        <div class="uk-width-medium-2-1">
                            <label>Semester</label>
                             <select id="select_demo_1" data-md-selectize name="semester">
                                    <option value="" <?php if($listing->semester == ''){ echo "selected=selected"; }?> > --Pilih-- </option>                          
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            <label>Kelas</label>
                             <select id="select_demo_1" data-md-selectize name="id_kelas">
                            
                            <?php 
                            foreach($opt_kelas->result() as $rowkls){  
                                if($listing->id_kelas == $rowkls->id){
                                    echo "<option value=".$rowkls->id." selected=selected> ".$rowkls->nama."</option>" ;
                                }else{
                                    echo "<option value=".$rowkls->id."> ".$rowkls->nama."</option>" ;
                                }
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            <label>Jurusan</label>
                             <select id="select_demo_1" data-md-selectize name="id_jurusan">
                            <option value="">--Pilh--</option>
                            <?php 
                            foreach($opt_jurusan->result() as $rowjrs){  
                            if($listing->id_jurusan == $rowjrs->id){
                                echo "<option value=".$rowjrs->id." selected=selected> ".$rowjrs->nm_jurusan."</option>" ;     
                            }else{
                                echo "<option value=".$rowjrs->id."> ".$rowjrs->nm_jurusan."</option>" ;     
                            }
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            ...
                            if($listing->id_kampus == $rowkampus->id){
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            <label>Jenis Kelamin</label>
                             <select id="select_demo_1" data-md-selectize name="jenis_kelamin">
                                <option value="">--Pilih--</option>
                                 
                                    <option value="L" <?php if($listing->jenis_kelamin == 'L') { echo "selected=selected"; }?> > Laki-Laki </option>
                                    <option value="P" <?php if($listing->jenis_kelamin == 'P') { echo "selected=selected"; }?> > Perempuan </option>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            <label>Email</label>
                            <input type="text" class="input-count md-input" id="input_counter" name="email" value="<?php echo $listing->email; ?>" maxlength="80" />
                        </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            <label>Alamat</label>
                            <input type="text" class="input-count md-input" id="input_counter" name="alamat"  maxlength="100" value="<?php echo $listing->alamat; ?>" />
                        </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            <label>No.Telp</label>
                            <input type="text" class="input-count md-input" id="input_counter" name="no_telp"  maxlength="13" value="<?php echo $listing->no_telp; ?>" />
                        </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            <label>Motto</label>
                            <input type="text" class="input-count md-input" id="input_counter" name="motto"  maxlength="100" value="<?php echo $listing->motto; ?>" />
                        </div>
