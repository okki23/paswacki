...
<body class=" sidebar_main_open sidebar_main_swipe">
    ...
    <div id="page_content">
        ...
        <h4> Selamat Datang <b> <?php echo $username; ?> ! </b> 
            ...
            <h1>Peserta</h1>
            <span class="uk-text-upper uk-text-small">Listing Data peserta PASWA</span>
            <br>
            ...
            <a href="<?php echo base_url('peserta/add');?>" class="md-btn md-btn-primary md-btn-wave-light" > <i class="material-icons">library_add</i> Add peserta</a>

            <a href="<?php echo base_url('print_peserta');?>" class="md-btn md-btn-primary md-btn-wave-light" > <i class="material-icons">print</i> Print peserta</a>
                            ...
                            <tr>
                                    ...
                                    <td>  
                                     ...
                                     <?php
                                        ...
                                        <a href="<?php echo base_url('print_peserta/detail/'.$row->id); ?>"> <i class="material-icons">account_box</i></a> 
                                        <?php
                                        }else{
                                        ?>

                                        <a href="<?php echo base_url('peserta/edit/'.$row->id); ?>"> <i class="material-icons md-24">create</i> </a>  &nbsp;  
                                        <a href="<?php echo base_url('peserta/delete/'.$row->id); ?>"  onclick="return confirm('Kamu yakin mau hapus data ini ?');"> <i class="material-icons md-24">delete_forever</i> </a> &nbsp; 
                                        <a href="<?php echo base_url('print_peserta/detail/'.$row->id); ?>"> <i class="material-icons">account_box</i></a>                                          
                                        <?php
                                        }
                                        ?>
