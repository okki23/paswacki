        ...
        <div id="page_content_inner">
            ...
            <div class="md-card">
                <div class="md-card-content">
                    <h1>Peserta</h1>
           			<span class="uk-text-upper uk-text-small">Form Add Peserta PASWA</span>
                   <form action="<?php echo base_url('peserta/pro_add');?>" method="POST" enctype="multipart/form-data"> 
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            <label>NIM</label>
                            <input type="text" class="input-count md-input" id="input_counter" name="nim" maxlength="12" />
                        </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            <label>Nama</label>
                            <input type="text" class="input-count md-input" id="input_counter" name="nama_peserta" required="required" maxlength="100" />
                        </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        ...
                        <select id="select_demo_1" data-md-selectize name="id_kampus">
                            <option value="">--Pilh--</option>
                            <?php 
                            foreach($opt_kampus->result() as $rowkps){  
                            echo "<option value=".$rowkps->id."> ".$rowkps->nm_kampus."</option>" ;      
                            }
                            ?> 
                        </select>
                     ...
                     <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            <label>Email</label>
                            <input type="text" class="input-count md-input" id="input_counter" name="email" maxlength="50" />
                        </div>
                     ...
                     <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            <label>Alamat</label>
                            <input type="text" class="input-count md-input" id="input_counter" name="alamat" maxlength="100" />
                        </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            ...
                            <input type="text" class="input-count md-input" id="input_counter" name="no_telp" maxlength="13" />
                        </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            ...
                            <input type="hidden" name="filename" id="revfile">
                        </div>
