        ...
        <div id="page_content_inner">
            ...
            <div class="md-card">
                <div class="md-card-content">
                   ...
                   <form action="<?php echo base_url('account_setting/pro_edit');?>" method="POST" enctype="multipart/form-data"> 

                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            <label>Username</label>
                            <input type="hidden" name="user_id" value="<?php echo $listing->user_id; ?>">
                            <input type="text" class="input-count md-input" id="input_counter" name="username" value="<?php echo $listing->username; ?>" />
                        </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            ...
                            <input type="password" class="input-count md-input" id="input_counter" name="password"   />
                        </div>
