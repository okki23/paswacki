...
<body class=" sidebar_main_open sidebar_main_swipe">
    ...
    <div id="page_content">
        ...
        <h4> Selamat Datang <b> <?php echo $username; ?> ! </b> 
            ...
            <span class="uk-text-upper uk-text-small">Manage Akun Pribadi</span>
                        ...
                        <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_issues">
                            ...
                            <tr>
                                    ...
                                    <td> <?php  echo $row->password; ?></td>
                                      ...
                                      <td>   <a href="<?php echo base_url('account_setting/edit/'.$user_id); ?>"> <i class="material-icons md-24">create</i> </a>  &nbsp;    &nbsp; </td>
                                </tr>
