    ...
    <div id="page_content">
        <div id="page_content_inner">
            ...
            <div class="md-card uk-margin-medium-bottom">
                ...
                <a href="<?php echo base_url('user/add'); ?>" class="md-btn md-btn-primary  md-btn-small md-btn-wave-light"> Add </a>
                    <table id="dt_tableTools" class="uk-table" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="<?php echo base_url('user/edit/'.$row->id);?>" class="md-btn md-btn-primary   md-btn-small md-btn-wave-light"> Edit </a> &nbsp;  <a href="<?php echo base_url('user/delete/'.$row->id);?>" class="md-btn md-btn-primary  md-btn-small md-btn-wave-light"> Hapus </a> </td>
                        </tr>
