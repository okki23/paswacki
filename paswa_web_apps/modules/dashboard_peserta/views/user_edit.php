    ...
    <div id="page_content">
        <div id="page_content_inner">
            ...
            <div class="md-card uk-margin-medium-bottom">
                 ...
                 <form action="<?php echo base_url('user/pro_edit');?>" method="POST">
            ...
            <div class="md-card">
                <div class="md-card-content">
                        ...
                        <div class="uk-width-medium-12-2">
                            ...
                            <div class="uk-form-row">
                                <div class="uk-grid">
                                    <div class="uk-width-medium-12-2">
                                        ...
                                        <input type="text" class="md-input" name="username" value="<?php echo $listing->username; ?>" />
                                    </div>
                            ...
                            <div class="uk-form-row">
                                 ...
                                 <select id="select_demo_1" data-md-selectize  name="level">
                                    ...
                                    <option value="2" <?php if($listing->level == '2'){ echo "selected=selected"; } ?>>User</option>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        ...
                        <span style="color:red;"> * Kosongkan kolom password jika password tidak ingin diganti </span>
