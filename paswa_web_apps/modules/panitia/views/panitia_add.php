        ...
        <div id="page_content_inner">
            ...
            <div class="md-card">
                <div class="md-card-content">
                    <h1>Panitia</h1>
           			<span class="uk-text-upper uk-text-small">Form Add Panitia PASWA</span>
                   <form action="<?php echo base_url('panitia/pro_add');?>" method="POST" enctype="multipart/form-data"> 
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            <label>Nama</label>
                            <input type="text" class="input-count md-input" id="input_counter" name="nm_panitia" />
                        </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            ...
                            <input type="text" class="input-count md-input" id="input_counter" name="telp" />
                        </div>
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-2-1">
                            <label>Alamat</label>
                            <input type="text" class="input-count md-input" id="input_counter" name="alamat" />
                        </div>
