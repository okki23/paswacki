...
<body class=" sidebar_main_open sidebar_main_swipe">
    ...
    <div id="page_content">
        ...
        <h4> Selamat Datang <b> <?php echo $username; ?> ! </b> 
            ...
            <br>
            <a href="<?php echo base_url('panitia/add');?>" class="md-btn md-btn-primary md-btn-wave-light" > + Add Panitia</a>
        </div>
                        ...
                        <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_issues">
                            ...
                            <tr>
                                    ...
                                    <td> <?php  echo $row->nm_jabatan; ?></td>
                                      ...
                                      <td>   <a href="<?php echo base_url('panitia/edit/'.$row->id); ?>"> <i class="material-icons md-24">create</i> </a>  &nbsp;   <a href="<?php echo base_url('panitia/delete/'.$row->id); ?>"  onclick="return confirm('Kamu yakin mau hapus data ini ?');"> <i class="material-icons md-24">delete_forever</i> </a> &nbsp;    </td>
                                </tr>
    ...
    <aside id="sidebar_secondary" class="tabbed_sidebar">
        <ul class="uk-tab uk-tab-icons uk-tab-grid" data-uk-tab="{connect:'#dashboard_sidebar_tabs', animation:'slide-horizontal'}">
            <li class="uk-active uk-width-1-3"><a href="#">Rundown PASWA 2016 <br><i class="material-icons">   &#xE422;</i></a></li>
                ...
                <br>
                    <div class="timeline timeline_small uk-margin-bottom">
                        <div class="timeline_item">
                            ...
                            <div class="timeline_content">Pembukaan Pendaftaran Paswa </div>
                        </div>

                        <div class="timeline_item">
                            <div class="timeline_icon timeline_icon_success"><i class="material-icons">&#xE85D;</i></div>
                            <div class="timeline_date">
                                <b>20 Agustus 2016 - 27 Agustus 2016 </b>
                            </div>
                            <div class="timeline_content">Sosialisasi Pendaftaran Paswa </div>
                        </div>
